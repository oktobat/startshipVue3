    ...
    <div id="menu_wrap" class="bg_white">
      ...
      <ul id="placesList">
        <li
          ...
          :key="index"
          @mouseover="displayInfowindow(markers[index], item.place_name)"
      ...
      <div id="pagination" ref="pageRef">
        <a
          href="#"
          v-for="num in pagination.last"
          :key="num"
          :class="{ on: num == pagination.current }"
          @click.prevent="pagination.gotoPage(num)"
        >
          <span>{{ num }}</span>
        </a>
      </div>
